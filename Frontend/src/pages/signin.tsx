...
const Signin: FC = () => {
  ...
  return (
    <>
      <div>
        <h1 className="text-3xl lg:text-4xl font-bold text-center mt-10 sm:text-2xl ">
          <i className="fa-sharp fa-solid fa-bowl-food px-2"></i>
          E-commerce
        </h1>
        <div className="container sm:w-10/12 lg:w-8/12  xl:w-4/12 mx-auto px-4 mt-6 lg:mt-16 bg-gray-200 p-8 rounded-lg shadow-lg ">
              ...
              <Form className="flex flex-col items-center">
                ...
                <div className="w-1/2 mt-5">
                  <button
                    ...
                    className="w-full lg:px-1 py-2 sm:text-sm text-lg lg:text-xl font-medium text-white transition-colors duration-200 transform bg-black rounded-lg hover:bg-gray-700 focus:outline-none focus:bg-gray-700"
                  >
                    Submit
                  </button>
                </div>
